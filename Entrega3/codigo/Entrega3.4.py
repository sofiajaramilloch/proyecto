...
def Map(path):
    ...
    Gmap.plot(CharminarTopAttractionLats, CharminarTopAttractionLons, 'lightgreen', edge_width = 3.0)
...
def main():
    ...
    print("El algoritmo 2 se demoró: ", tiempoTotal ," segundos en encontrar el camino")
